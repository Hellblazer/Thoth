...
abstract public class AbstractNode<E extends Perceiving> implements Node, Cursor, Cloneable {
    ...
    public AbstractNode(E entity, UUID id, Point3i location, int aoiRadius, int maximumVelocity) {
        this.sim = entity;
