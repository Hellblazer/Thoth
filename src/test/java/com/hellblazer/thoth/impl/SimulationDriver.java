...
public class SimulationDriver {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        System.out.println("real time elapsed: " + (System.currentTimeMillis() - now) / 1000.0 + " Seconds");
    ...
    public void start(SimEntity entity, Perceptron<Perceiving> node, AbstractNode<Perceiving> gateway,
                      Random simRandom) {
